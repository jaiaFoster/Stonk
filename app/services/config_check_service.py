...
def build_config_check(run_mode: str = "prod") -> dict[str, Any]:
    ...
    limits = {
        ...
        "usage_telemetry_enabled": config.USAGE_TELEMETRY_ENABLED,
        "usage_telemetry_db_path": config.USAGE_TELEMETRY_DB_PATH,
        "usage_telemetry_retention_limit": config.USAGE_TELEMETRY_RETENTION_LIMIT,
        "usage_telemetry_size_profile_retention_limit": config.USAGE_TELEMETRY_SIZE_PROFILE_RETENTION_LIMIT,
        "usage_telemetry_size_warning_bytes": config.USAGE_TELEMETRY_SIZE_WARNING_BYTES,
        "usage_telemetry_size_large_bytes": config.USAGE_TELEMETRY_SIZE_LARGE_BYTES,
        "usage_telemetry_size_critical_bytes": config.USAGE_TELEMETRY_SIZE_CRITICAL_BYTES,
        ...
        "report_snapshot_store_compressed_full": config.REPORT_SNAPSHOT_STORE_COMPRESSED_FULL,
        "report_snapshot_hot_log_lines": config.REPORT_SNAPSHOT_HOT_LOG_LINES,
        "report_snapshot_hot_strategy_rows": config.REPORT_SNAPSHOT_HOT_STRATEGY_ROWS,
        "run_manifest_retention_limit": config.RUN_MANIFEST_RETENTION_LIMIT,
        "active_trades_default_detail": config.ACTIVE_TRADES_DEFAULT_DETAIL,
        ...
        "forward_factor_candidate_discovery_pool_size": config.FF_CANDIDATE_DISCOVERY_POOL_SIZE,
        "forward_factor_candidate_history_lookback_runs": config.FF_CANDIDATE_HISTORY_LOOKBACK_RUNS,
        "forward_factor_scan_mode": config.FF_SCAN_MODE,
