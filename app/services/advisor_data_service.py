...
def build_advisor_snapshot_payload(snapshot: dict[str, Any], summary: dict[str, Any], report: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "ff_journal_summary": {
            "total_observations": ff_journal.get("total_observations") or ff_journal.get("total") or 0,
            "distinct_tickers": ff_journal.get("tickers_observed") or ff_journal.get("tickers") or 0,
            "distinct_runs": ff_journal.get("runs_recorded") or ff_journal.get("runs") or 0,
            "latest_date": ff_journal.get("latest_run_date") or ff_journal.get("latest_date"),
        },
