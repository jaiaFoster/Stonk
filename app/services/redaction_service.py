...
def known_secrets() -> list[str]:
    names = ("ROBINHOOD_PASSWORD", "NEWS_API_KEY", "FINNHUB_API_KEY", "ALPHA_VANTAGE_API_KEY", "TRADIER_ACCESS_TOKEN", "RUN_TOKEN", "DEV_API_TOKEN", "NTFY_TOPIC", "PLAID_SECRET", "PLAID_CLIENT_ID")
