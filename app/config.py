...
STRATEGY_ROW_DB_PATH = os.environ.get("STRATEGY_ROW_DB_PATH", REPORT_SNAPSHOT_DB_PATH)
...
DEV_ENDPOINT_VERIFICATION_ENABLED = _bool_env("DEV_ENDPOINT_VERIFICATION_ENABLED", os.environ.get("APP_MODE", "prod").strip().lower() == "dev")
DEV_ENDPOINT_VERIFICATION_TIMEOUT_SECONDS = _int_env("DEV_ENDPOINT_VERIFICATION_TIMEOUT_SECONDS", 10)
DEV_ENDPOINT_VERIFICATION_INCLUDE_SAMPLES = _bool_env("DEV_ENDPOINT_VERIFICATION_INCLUDE_SAMPLES", False)
...
STRATEGY_DEFINITION_LOADER_ENABLED = _bool_env("STRATEGY_DEFINITION_LOADER_ENABLED", True)
STRATEGY_DEFINITION_DIR = os.environ.get("STRATEGY_DEFINITION_DIR", "config/strategies")
CALENDAR_EXPIRATION_ENUMERATION_POLICY_VERSION = os.environ.get(
    "CALENDAR_EXPIRATION_ENUMERATION_POLICY_VERSION",
    "34A.expiration_enumeration.v1",
)
CALENDAR_PREWINDOW_LOOKAHEAD_DAYS = _int_env("CALENDAR_PREWINDOW_LOOKAHEAD_DAYS", 21)
...
CALENDAR_MIN_FRONT_LEG_DTE = _int_env("CALENDAR_MIN_FRONT_LEG_DTE", 7)
CALENDAR_FRONT_MIN_DTE = max(_int_env("CALENDAR_FRONT_MIN_DTE", CALENDAR_MIN_FRONT_LEG_DTE), CALENDAR_MIN_FRONT_LEG_DTE)
...
CALENDAR_HIGH_MOVE_WARNING_THRESHOLD = _float_env("CALENDAR_HIGH_MOVE_WARNING_THRESHOLD", 0.08)
...
# Distinct provider dates close enough to plausibly be symbol/date bleed are
# unsafe for event trades even when they exceed the normal merge tolerance.
EARNINGS_DATE_BLEED_SUSPECT_WINDOW_DAYS = _int_env("EARNINGS_DATE_BLEED_SUSPECT_WINDOW_DAYS", 10)
EARNINGS_DATE_REQUIRE_MULTI_SOURCE = _bool_env("EARNINGS_DATE_REQUIRE_MULTI_SOURCE", False)
EARNINGS_MIN_SOURCES_FOR_HIGH_CONFIDENCE = _int_env("EARNINGS_MIN_SOURCES_FOR_HIGH_CONFIDENCE", 2)
EARNINGS_TRUST_REQUIRE_MULTI_SOURCE_FOR_CALENDAR_PASS = _bool_env("EARNINGS_TRUST_REQUIRE_MULTI_SOURCE_FOR_CALENDAR_PASS", False)  # single-source = warning, not block (Patch 29.6)
EARNINGS_TRUST_SINGLE_SOURCE_CAN_WATCH = _bool_env("EARNINGS_TRUST_SINGLE_SOURCE_CAN_WATCH", True)
EARNINGS_TRUST_CONFLICT_CAN_PASS = _bool_env("EARNINGS_TRUST_CONFLICT_CAN_PASS", False)
EARNINGS_TRUST_UNKNOWN_CAN_PASS = _bool_env("EARNINGS_TRUST_UNKNOWN_CAN_PASS", False)
...
EARNINGS_EXCLUDED_FUND_TICKERS = os.environ.get("EARNINGS_EXCLUDED_FUND_TICKERS", "NAD,NEA,NMZ,NUV,NVG,ACP,AOD,FAX,NZF")
...
EARNINGS_DISCOVERY_MIN_AVERAGE_VOLUME = _int_env("EARNINGS_DISCOVERY_MIN_AVERAGE_VOLUME", 250000)
EARNINGS_DISCOVERY_MAX_TICKERS_PER_RUN = _int_env("EARNINGS_DISCOVERY_MAX_TICKERS_PER_RUN", 6)
EARNINGS_DISCOVERY_CONSTITUENT_PRESCREEN = _bool_env("EARNINGS_DISCOVERY_CONSTITUENT_PRESCREEN", True)
...
CALENDAR_EARNINGS_FRONT_MIN_DTE = max(_int_env("CALENDAR_EARNINGS_FRONT_MIN_DTE", CALENDAR_MIN_FRONT_LEG_DTE), CALENDAR_MIN_FRONT_LEG_DTE)
CALENDAR_EARNINGS_FRONT_MAX_DTE = _int_env("CALENDAR_EARNINGS_FRONT_MAX_DTE", 14)
CALENDAR_SHORT_LEG_STEP_WINDOW_DAYS = _int_env("CALENDAR_SHORT_LEG_STEP_WINDOW_DAYS", 10)
EARNINGS_CALENDAR_ENTRY_MIN_SHORT_DTE = _int_env("EARNINGS_CALENDAR_ENTRY_MIN_SHORT_DTE", 4)
EARNINGS_CALENDAR_ENTRY_PREFERRED_MIN_DTE = _int_env("EARNINGS_CALENDAR_ENTRY_PREFERRED_MIN_DTE", 5)
EARNINGS_CALENDAR_ENTRY_PREFERRED_MAX_DTE = _int_env("EARNINGS_CALENDAR_ENTRY_PREFERRED_MAX_DTE", 10)
...
SKEW_MIN_SPREAD_DTE = _int_env("SKEW_MIN_SPREAD_DTE", 21)
SKEW_VERTICAL_MIN_DTE = max(_int_env("SKEW_VERTICAL_MIN_DTE", SKEW_MIN_SPREAD_DTE), SKEW_MIN_SPREAD_DTE)
...
SKEW_UNIVERSE_MAX_CANDIDATES = _int_env("SKEW_UNIVERSE_MAX_CANDIDATES", 50)
...
PUBLIC_DEMO_TELEMETRY_MAX_PER_MINUTE = _int_env("PUBLIC_DEMO_TELEMETRY_MAX_PER_MINUTE", 120)
FF_GRAD_MIN_CALC_COMPLETE = _int_env("FF_GRAD_MIN_CALC_COMPLETE", 20)
FF_GRAD_MIN_POSITIVE = _int_env("FF_GRAD_MIN_POSITIVE", 5)
FF_GRAD_MIN_SOURCE_QUALIFIED = _int_env("FF_GRAD_MIN_SOURCE_QUALIFIED", 3)
FF_GRAD_MIN_STRUCTURE_COMPLETE = _int_env("FF_GRAD_MIN_STRUCTURE_COMPLETE", 3)
FF_GRAD_MIN_MANUAL_REVIEWS = _int_env("FF_GRAD_MIN_MANUAL_REVIEWS", 1)
...
FF_WATCH_FF_LOWER_BOUND = _float_env("FF_WATCH_FF_LOWER_BOUND", 0.12)
FF_MIN_FRONT_LEG_DTE = _int_env("FF_MIN_FRONT_LEG_DTE", 7)
# 31B.4: Widened DTE ranges — front hard range 35–90 (was 50–70), back derived from front+gap.
FF_FRONT_TARGET_DTE = _int_env("FF_FRONT_TARGET_DTE", 60)
FF_FRONT_TARGET_DTE_MIN = _int_env("FF_FRONT_TARGET_DTE_MIN", 45)
FF_FRONT_TARGET_DTE_MAX = _int_env("FF_FRONT_TARGET_DTE_MAX", 80)
FF_FRONT_DTE_MIN = max(_int_env("FF_FRONT_DTE_MIN", 35), FF_MIN_FRONT_LEG_DTE)
FF_FRONT_DTE_MAX = _int_env("FF_FRONT_DTE_MAX", 90)
FF_BACK_TARGET_DTE = _int_env("FF_BACK_TARGET_DTE", 90)
# Back DTE is now derived from front + gap; FF_BACK_DTE_MIN/MAX kept for fallback compatibility.
FF_BACK_DTE_MIN = _int_env("FF_BACK_DTE_MIN", 49)
FF_BACK_DTE_MAX = _int_env("FF_BACK_DTE_MAX", 139)
FF_USE_DERIVED_BACK_DTE = _bool_env("FF_USE_DERIVED_BACK_DTE", True)
FF_MIN_EXPIRATION_GAP_DAYS = _int_env("FF_MIN_EXPIRATION_GAP_DAYS", 14)
FF_MAX_EXPIRATION_GAP_DAYS = _int_env("FF_MAX_EXPIRATION_GAP_DAYS", 49)
FF_SEPARATION_TARGET_MIN = _int_env("FF_SEPARATION_TARGET_MIN", 21)
FF_SEPARATION_TARGET_MAX = _int_env("FF_SEPARATION_TARGET_MAX", 35)
FF_EXPIRATION_PAIRS_PER_TICKER = _int_env("FF_EXPIRATION_PAIRS_PER_TICKER", 5)
FF_CHAIN_EXPIRATIONS_PER_TICKER = _int_env("FF_CHAIN_EXPIRATIONS_PER_TICKER", 8)
...
FF_MIN_LEG_OPEN_INTEREST = _int_env("FF_MIN_LEG_OPEN_INTEREST", 10)
FF_MIN_LEG_VOLUME = _int_env("FF_MIN_LEG_VOLUME", 0)
FF_MAX_LEG_BID_ASK_PCT = _float_env("FF_MAX_LEG_BID_ASK_PCT", 35)
FF_MAX_PACKAGE_SLIPPAGE_PCT = _float_env("FF_MAX_PACKAGE_SLIPPAGE_PCT", 60)
FF_WARN_PACKAGE_SLIPPAGE_PCT = _float_env("FF_WARN_PACKAGE_SLIPPAGE_PCT", 30)
...
FF_DEV_MAX_CHAIN_TICKERS_PER_RUN = _int_env("FF_DEV_MAX_CHAIN_TICKERS_PER_RUN", 3)
FF_MAX_CANDIDATES_PER_TICKER = _int_env("FF_MAX_CANDIDATES_PER_TICKER", 3)
FF_UNIVERSE_MAX_TICKERS = _int_env("FF_UNIVERSE_MAX_TICKERS", 40)
...
FF_DEV_CAP_DISCOVERY_SLOTS = _int_env("FF_DEV_CAP_DISCOVERY_SLOTS", 1)
FF_NEAR_MISS_WINDOW = _float_env("FF_NEAR_MISS_WINDOW", 0.05)
# 32C: Near-miss tolerances — how far past a gate limit still qualifies as NEAR MISS vs hard FAIL
FF_NEAR_MISS_DEBIT_TOLERANCE_PCT = _float_env("FF_NEAR_MISS_DEBIT_TOLERANCE_PCT", 20.0)
FF_NEAR_MISS_SPREAD_TOLERANCE_PCT = _float_env("FF_NEAR_MISS_SPREAD_TOLERANCE_PCT", 20.0)
FF_NEAR_MISS_OI_TOLERANCE_PCT = _float_env("FF_NEAR_MISS_OI_TOLERANCE_PCT", 50.0)
# 32C: Discovery rate — wider caps so the ranking engine surfaces more candidates
...
# Hard-ceiling scores by verdict class (must not contradict verdict)
UNIVERSAL_SCORE_HARD_FAIL_CEILING = _int_env("UNIVERSAL_SCORE_HARD_FAIL_CEILING", 39)
UNIVERSAL_SCORE_DIAGNOSTIC_CEILING = _int_env("UNIVERSAL_SCORE_DIAGNOSTIC_CEILING", 29)
UNIVERSAL_SCORE_WATCH_MAX = _int_env("UNIVERSAL_SCORE_WATCH_MAX", 74)
UNIVERSAL_SCORE_PASS_MIN = _int_env("UNIVERSAL_SCORE_PASS_MIN", 75)
# Tier thresholds
UNIVERSAL_TIER_A_MIN_SCORE = _int_env("UNIVERSAL_TIER_A_MIN_SCORE", 75)
UNIVERSAL_TIER_B_MIN_SCORE = _int_env("UNIVERSAL_TIER_B_MIN_SCORE", 55)
UNIVERSAL_TIER_C_MIN_SCORE = _int_env("UNIVERSAL_TIER_C_MIN_SCORE", 40)
# Component weights (sum to 1.0)
UNIVERSAL_WEIGHT_RETURN = _float_env("UNIVERSAL_WEIGHT_RETURN", 0.20)
UNIVERSAL_WEIGHT_RISK = _float_env("UNIVERSAL_WEIGHT_RISK", 0.15)
UNIVERSAL_WEIGHT_CONFIDENCE = _float_env("UNIVERSAL_WEIGHT_CONFIDENCE", 0.15)
UNIVERSAL_WEIGHT_LIQUIDITY = _float_env("UNIVERSAL_WEIGHT_LIQUIDITY", 0.15)
UNIVERSAL_WEIGHT_DATA_QUALITY = _float_env("UNIVERSAL_WEIGHT_DATA_QUALITY", 0.10)
UNIVERSAL_WEIGHT_CAPITAL_EFFICIENCY = _float_env("UNIVERSAL_WEIGHT_CAPITAL_EFFICIENCY", 0.10)
UNIVERSAL_WEIGHT_TIMING = _float_env("UNIVERSAL_WEIGHT_TIMING", 0.05)
UNIVERSAL_WEIGHT_HISTORICAL = _float_env("UNIVERSAL_WEIGHT_HISTORICAL", 0.05)
UNIVERSAL_WEIGHT_PORTFOLIO_FIT = _float_env("UNIVERSAL_WEIGHT_PORTFOLIO_FIT", 0.05)
