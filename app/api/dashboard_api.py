...
def build_dashboard_summary() -> dict[str, Any]:
    ...
    return {
        **_READ_ONLY_BASE,
        ...
        "compact_summary_json_bytes": manifest.get("compact_summary_json_bytes", manifest.get("summary_json_bytes", 0)),
        "legacy_report_summary_json_bytes": manifest.get("legacy_report_summary_json_bytes", 0),
        "full_archive_blob_bytes": manifest.get("full_archive_blob_bytes", 0),
        "raw_provider_archive_blob_bytes": manifest.get("raw_provider_archive_blob_bytes", 0),
